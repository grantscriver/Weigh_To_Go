...
for (var i = 0; i< foodData.length; i++) {
  if (i==0) {
    ...
    foodDataArray.push({foodname: foodData[i].foodname, food_calories_uom: foodData[i].food_calories_uom,servings_consumed: foodData[i].servings_consumed,total_calories: foodData[i].total_calories,daily_total_calories: foodData[i].total_calories})  
  }
  else {
    daily_total = daily_total+Number(foodData[i].total_calories)
    foodDataArray.push({foodname: foodData[i].foodname, food_calories_uom: foodData[i].food_calories_uom,servings_consumed: foodData[i].servings_consumed,total_calories: foodData[i].total_calories,daily_total_calories: daily_total})  
  }
}
